...
![](Aspose.Words.50fa17df-01d7-4de6-8d01-d77b5ba98a71.004.png)

- Página RPL:

Esta página será cumplimentada por el técnico de documentación con las indicaciones que le realice el gestor. Se introducirán los pdf que la empresa madre necesita para la gestión de PRL y se los técnicos necesarios para la obra, además de los RP y los reservas.
...
## 7. **Controles de accesos. ¿Qué grupos existen? ¿Quién puede acceder o no al módulo? ¿A qué modelos? ¿a qué registros? ¿Con qué permisos?**
  ...
  - Visualización: 
    Los técnicos asignados a la obra podrán ver la hoja de replanteo para saber cual es el trabajo a realizar. Podrán bajarse tambien un pdf con toda la información.
  - Edición: 
    El project manager, el Gestor, y los técnicos de documentación podrán tener edición en este módulo.
